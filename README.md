...
# curl -X POST --loginUser 'clientapp:123' -d 'grant_type=password&username=loginUser&password=123456' http://localhost:8080/oauth/token
POST http://localhost:8080/oauth/token
Authorization: Basic clientapp 123
Content-Type: application/x-www-form-urlencoded

grant_type=password&username=loginUser&password=123456
